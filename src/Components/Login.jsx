...
//     useEffect runs when the component is mounted due to the empty dependency array [] (only runs once).
 
// document.body.style.overflow = 'hidden' prevents scrolling by hiding the scrollbar.

// The cleanup function (inside return) sets overflow back to unset when the component is unmounted, restoring scroll behavior.
    ...
    justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img src={assets.email_icon} className='w-10' alt="" />
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img src={assets.lock_icon} className='w-10' alt="" />
            ...
            {state=='Login'?<p className='mt-4 text-center'>Don't have an account?
                <span className='text-blue-500 cursor-pointer' onClick={()=>setState('Sign Up')}>Sign Up</span></p>
